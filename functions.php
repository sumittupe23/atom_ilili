...
function my_custom_styles() {
	...
	// My Custom Styles
	wp_enqueue_style( 'bootstrap-style', get_template_directory_uri() . '/css/bootstrap.min.css', array(), '1.1' );
	wp_enqueue_style( 'font-awesome', get_template_directory_uri() . '/css/font-awesome.min.css', array(), '1.1' );
	wp_enqueue_style( 'main-style', get_template_directory_uri() . '/css/main_style.css', array(), '1.1' );
	wp_enqueue_style( 'custom-style', get_template_directory_uri() . '/css/custom_styles.css', array(), '1.1' );
	wp_enqueue_style( 'bootstrap-element-style', get_template_directory_uri() . '/css/bootstrap_elements_style.css', array(), '1.1' );
	wp_enqueue_style( 'custom-animations', get_template_directory_uri() . '/css/custom_animations.css', array(), '1.1' );

	// My Custom Scripts
	wp_enqueue_script( 'bootstrap-js', get_template_directory_uri() . '/js/bootstrap.min.js', array( 'jquery' ), '1.3.0', true );
	wp_enqueue_script( 'main-js', get_template_directory_uri() . '/js/main.js', array( 'jquery' ), '1.2.0', true );
	wp_enqueue_script( 'jquery-ui', get_template_directory_uri() . '/js/jquery.js', array( 'jquery' ), '1.1.0', true );
}
