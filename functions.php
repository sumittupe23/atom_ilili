...
function my_custom_styles() {
	...
	wp_enqueue_style( 'custom-style', get_template_directory_uri() . '/css/custom_styles.css', array(), '1.7' );
	...
	wp_enqueue_script( 'jquery-ui', get_template_directory_uri() . '/js/jquery.js', array( 'jquery' ), '1.5.0', true );
}
